...
return array(
    ...
    'CreateItemsTable' => $baseDir . '/database/migrations/2016_09_19_154913_create_items_table.php',
    ...
    'Czim\\Filter\\Contracts\\CountableFilterInterface' => $vendorDir . '/czim/laravel-filter/src/Contracts/CountableFilterInterface.php',
    'Czim\\Filter\\Contracts\\FilterDataInterface' => $vendorDir . '/czim/laravel-filter/src/Contracts/FilterDataInterface.php',
    'Czim\\Filter\\Contracts\\FilterInterface' => $vendorDir . '/czim/laravel-filter/src/Contracts/FilterInterface.php',
    'Czim\\Filter\\Contracts\\ParameterCounterInterface' => $vendorDir . '/czim/laravel-filter/src/Contracts/ParameterCounterInterface.php',
    'Czim\\Filter\\Contracts\\ParameterFilterInterface' => $vendorDir . '/czim/laravel-filter/src/Contracts/ParameterFilterInterface.php',
    'Czim\\Filter\\Contracts\\ValidatableTraitInterface' => $vendorDir . '/czim/laravel-filter/src/Contracts/ValidatableTraitInterface.php',
    'Czim\\Filter\\CountableFilter' => $vendorDir . '/czim/laravel-filter/src/CountableFilter.php',
    'Czim\\Filter\\CountableResults' => $vendorDir . '/czim/laravel-filter/src/CountableResults.php',
    'Czim\\Filter\\Enums\\JoinKey' => $vendorDir . '/czim/laravel-filter/src/Enums/JoinKey.php',
    'Czim\\Filter\\Exceptions\\FilterDataValidationFailedException' => $vendorDir . '/czim/laravel-filter/src/Exceptions/FilterDataValidationFailedException.php',
    'Czim\\Filter\\Exceptions\\FilterParameterUnhandledException' => $vendorDir . '/czim/laravel-filter/src/Exceptions/FilterParameterUnhandledException.php',
    'Czim\\Filter\\Exceptions\\ParameterStrategyInvalidException' => $vendorDir . '/czim/laravel-filter/src/Exceptions/ParameterStrategyInvalidException.php',
    'Czim\\Filter\\Filter' => $vendorDir . '/czim/laravel-filter/src/Filter.php',
    'Czim\\Filter\\FilterData' => $vendorDir . '/czim/laravel-filter/src/FilterData.php',
    'Czim\\Filter\\FilterServiceProvider' => $vendorDir . '/czim/laravel-filter/src/FilterServiceProvider.php',
    'Czim\\Filter\\ParameterCounters\\SimpleBelongsTo' => $vendorDir . '/czim/laravel-filter/src/ParameterCounters/SimpleBelongsTo.php',
    'Czim\\Filter\\ParameterCounters\\SimpleDistinctValue' => $vendorDir . '/czim/laravel-filter/src/ParameterCounters/SimpleDistinctValue.php',
    'Czim\\Filter\\ParameterFilters\\IsEmpty' => $vendorDir . '/czim/laravel-filter/src/ParameterFilters/Empty.php',
    'Czim\\Filter\\ParameterFilters\\NotEmpty' => $vendorDir . '/czim/laravel-filter/src/ParameterFilters/NotEmpty.php',
    'Czim\\Filter\\ParameterFilters\\SimpleInteger' => $vendorDir . '/czim/laravel-filter/src/ParameterFilters/SimpleInteger.php',
    'Czim\\Filter\\ParameterFilters\\SimpleString' => $vendorDir . '/czim/laravel-filter/src/ParameterFilters/SimpleString.php',
    'Czim\\Filter\\ParameterFilters\\SimpleTranslatedString' => $vendorDir . '/czim/laravel-filter/src/ParameterFilters/SimpleTranslatedString.php',
    'Czim\\Filter\\Traits\\Validatable' => $vendorDir . '/czim/laravel-filter/src/Traits/Validatable.php',
